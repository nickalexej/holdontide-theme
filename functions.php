...
#region Add Brevo CSS
function add_brevo_css() {
    echo '
    <style>
        @font-face {
            font-display: block;
...
add_action( 'wp_head', 'add_brevo_css' );

function add_brevo_script() {
    echo "
    <script>
...
add_action( 'wp_footer', 'add_brevo_script' );
#endregion Add Brevo CSS